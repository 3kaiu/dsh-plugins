...
export function isCjk(text: any) { return CJK_RE.test(text) }

export function cjkFontFallback(requested: any) {
...
export function cjkLineBreak(text: any) {
...
export function cjkPunctWidth(text: any) {
