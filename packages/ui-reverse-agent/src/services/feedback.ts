...
export function captureFeedback({ iteration, path: p, prop, expected, actual, userCorrection, reason }: any, { feedbackPath = '.ui-reverse/feedback.json' }: Record<string, any> = {}) {
