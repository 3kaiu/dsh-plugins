 ...
 */
export function locateRegions(opts: any) {
...
function buildRepairPrompt(req: any, ctx: any) {
  const lines = []
 ...
 */
export function deterministicRepair(req: any, ctx: any) {
 ...
 */
export function verifyOnce(opts: any) {
 ...
 */
export function applyPatch(projectDir: any, patch: any) {
